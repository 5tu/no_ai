...
function searchGoogleImages() {
  ...
  const query = searchTerm + '  -"ai" -"stable diffusion" -"midjourney" -"open art" -"prompt hunt" -"realistic vision" -site:impossibleimages.ai -site:impossibleimages.ai -site:freewayml.com -site:runwayml.com -site:lexica.art -site:tensor.art -site:civitai.com -site:opensea.io';
